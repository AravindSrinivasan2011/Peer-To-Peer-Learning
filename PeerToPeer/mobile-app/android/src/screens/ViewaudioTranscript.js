...
import {search,searchaudio} from './lib/Utils'
import Sound from 'react-native-sound';


const ViewaudioTranscript = function ({ navigation }) {
    ...
    return (
        <TouchableOpacity style={styles.itemTouchable}>
          <View style={styles.itemView}>
            ...
            >
          <Text style={styles.itemName}>View Transcript</Text>
         </TouchableHighlight>
          </View>
        </TouchableOpacity>
    ...
    const openVideo = (video1)  => {
     ...
     console.log("audio content",video1);
      const audio = new Sound(video1, null, (error) => {
        if (error) {
          // do something
        }
         audio.play();
...
export default ViewaudioTranscript;
